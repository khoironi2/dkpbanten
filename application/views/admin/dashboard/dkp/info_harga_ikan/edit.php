                    ...
                    <div class="col-md-9">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?= base_url('dkp/info_harga_ikan/update') ?>" enctype="multipart/form-data">

                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Nama <span class="mandatory">*</span></label>
                                            <input type="text" value="<?= $edit_hi['nama_harga_ikan'] ?>" name="nama_harga_ikan" id="nama_harga_ikan" class="form-control">
                                            <input type="text" hidden value="<?= $edit_hi['id_info_harga_ikan'] ?>" name="id_info_harga_ikan" id="id_info_harga_ikan" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Link <span class="mandatory">*</span></label>
                                            <input type="text" value="<?= $edit_hi['link_harga_ikan'] ?>" name="link_harga_ikan" id="link_harga_ikan" class="form-control">
                                        </div>
                                    </div>
