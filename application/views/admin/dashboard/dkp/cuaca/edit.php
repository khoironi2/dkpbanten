                    ...
                    <div class="col-md-9">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?= base_url('dkp/cuaca/update') ?>" enctype="multipart/form-data">

                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Nama <span class="mandatory">*</span></label>
                                            <input type="text" value="<?= $edit_cuaca['nama_cuaca'] ?>" name="nama_cuaca" id="nomor" class="form-control">
                                            <input type="text" hidden value="<?= $edit_cuaca['id_cuaca'] ?>" name="id_cuaca" id="id_cuaca" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Link <span class="mandatory">*</span></label>
                                            <input type="text" value="<?= $edit_cuaca['link_cuaca'] ?>" name="link_cuaca" id="link_cuaca" class="form-control">
                                        </div>
                                    </div>
