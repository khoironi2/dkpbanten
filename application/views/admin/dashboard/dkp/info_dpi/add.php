                    ...
                    <div class="col-md-9">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?= base_url('dkp/info_dpi/save') ?>" enctype="multipart/form-data">

                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Nama <span class="mandatory">*</span></label>
                                            <input type="text" name="nama_info_dpi" id="nama_info_dpi" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Link <span class="mandatory">*</span></label>
                                            <input type="text" name="link_info_dpi" id="link_info_dpi" class="form-control">
                                        </div>
                                    </div>
