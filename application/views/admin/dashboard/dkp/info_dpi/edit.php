                    ...
                    <div class="col-md-9">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?= base_url('dkp/info_dpi/update') ?>" enctype="multipart/form-data">

                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Nama <span class="mandatory">*</span></label>
                                            <input type="text" value="<?= $edit_dpi['nama_info_dpi'] ?>" name="nama_info_dpi" id="nomor" class="form-control">
                                            <input type="text" hidden value="<?= $edit_dpi['id_info_dpi'] ?>" name="id_info_dpi" id="id_info_dpi" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="jenisikan">Link <span class="mandatory">*</span></label>
                                            <input type="text" value="<?= $edit_dpi['link_info_dpi'] ?>" name="link_info_dpi" id="link_info_dpi" class="form-control">
                                        </div>
                                    </div>
