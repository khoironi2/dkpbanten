                    ...
                    <tbody>
                        ...
                        foreach ($perusahaan as $data) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('master/perusahaan/edit/' . $data['id_perusahaan']) ?>"><i class="fas fa-edit"></i></a>
                                    <a data-toggle="modal" data-target="#delete<?= $data['id_perusahaan'] ?>"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
