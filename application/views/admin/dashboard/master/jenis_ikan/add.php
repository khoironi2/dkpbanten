                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <form method="post" action="http://103.41.205.125/kalbusmarttrial/jenis-ikan/add" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="namelatin" id="namelatin" value="" maxlength="255" />
                                        </div>
                                        <div class="form-group">
                                            <label for="namedaerah">Nama Daerah <span class="mandatory">*</span></label>
                                            <input type="text" class="form-control" name="namedaerah" id="namedaerah" value="" maxlength="255" />
                                        </div>
                                        <div class="form-group">
                                            <label for="fileurl">Gambar / File Jenis Ikan</label>
                                            <input type="file" class="form-control" name="fileurl" id="fileurl" />
                                        </div>
                                        <div class="form-group">
