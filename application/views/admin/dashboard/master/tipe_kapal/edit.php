                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <form method="post" action="<?= base_url('master/tipe_kapal/update') ?>">
                                        <?php foreach ($edit_jenis_kapal as $data) : ?>
                                            <div class="form-group">
                                                <label for="name">Nama <span class="mandatory">*</span></label>
                                                <input type="text" class="form-control" value="<?= $data['nama_tipe_kapal'] ?>" name="nama_tipe_kapal" id="nama_tipe_kapal" maxlength="255" required />
                                                <input type="text" hidden class="form-control" value="<?= $data['id_tipe_kapal'] ?>" name="id_tipe_kapal" id="id_tipe_kapal" maxlength="255" required />
                                            </div>
                                            <div class="form-group">
