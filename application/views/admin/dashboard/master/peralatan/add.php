                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <form method="post" action="http://103.41.205.125/kalbusmarttrial/peralatan/add" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="type" id="type" class="form-control" value="" maxlength="255">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control dotseparator" name="stock" id="stocks" value="" maxlength="15" />
                                        </div>
                                        <div class="form-group">
