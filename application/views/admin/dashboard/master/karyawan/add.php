                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <form method="post" action="http://103.41.205.125/kalbusmarttrial/karyawan/add" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control date" name="birthdate" id="birthdates" value="" maxlength="10" readonly />
                                                </div>
                                                <div class="form-group">
