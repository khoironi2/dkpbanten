                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <form method="post" action="<?= base_url('master/karyawan/save') ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nip" id="nip" maxlength="255" />
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control date" name="tgl_lahir" id="tgl_lahir" maxlength="10" />
                                                </div>
                                                <div class="form-group">
