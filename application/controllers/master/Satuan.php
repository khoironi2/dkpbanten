...
class Satuan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/dashboard/master/satuan/index', $data);
    ...
    public function edit($id)
    {
        ...
        $data = [
            ...
            'jabatan' => $this->Pegawai_model->getAll(),
            'satuan' => $this->Satuan_model->getAll(),
            'edit_satuan' => $this->Satuan_model->getid($id),
            'profil' => $this->Profil_model->getAll()
        ];
        ...
        $this->load->view('templates/sidebar');
        // $this->load->view('templates/topbar');
        $this->load->view('admin/dashboard/master/satuan/edit', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function add()
    {
        ...
        $this->load->view('templates/sidebar');
        // $this->load->view('templates/topbar');
        $this->load->view('admin/dashboard/master/satuan/add', $data);
        $this->load->view('templates/footer');
    }
    public function save()
    {
        ...
        $insert = $this->Satuan_model->insert($data);
    ...
    public function update()
    {
        ...
        $update = $this->Satuan_model->update($id, $data);
        if ($update) {
    ...
    {
        $data['id_satuan'] = $this->Satuan_model->delete($id);
